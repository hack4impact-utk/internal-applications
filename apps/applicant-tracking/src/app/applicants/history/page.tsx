...
const data = [
  { date: '2023', ap: 50, ac: 25, ret: 10 },
  { date: '2024', ap: 30, ac: 70, ret: 60 },
  { date: '2025', ap: 80, ac: 60, ret: 30 },
];
const graphKeys = {
  '&:hover': {
...
export default function HistoryPage() {
  return (
    <>
      ...
      <Box
        sx={{ width: '95%', height: 5, bgcolor: 'orange', margin: 'auto' }}
      />
      ...
      >
        <Button
          variant="contained"
          startIcon={<Circle style={{ fill: '#72b8cc' }} />}
          sx={graphKeys}
        >
          Applications
        </Button>
        <Button
          variant="contained"
          startIcon={<Circle style={{ fill: '#ab6563' }} />}
          sx={graphKeys}
        >
          Admitted
        </Button>
        <Button
          variant="contained"
          startIcon={<Circle style={{ fill: '#e3a457' }} />}
          sx={graphKeys}
        >
          Retention
        </Button>
